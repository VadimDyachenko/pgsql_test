...
public class AddressService extends Util implements AddressDAO {
    ...
    public List<Address> getAll() throws SQLException {
        ...
        String sql = "SELECT \"ID\", \"COUNTRY\", \"CITY\", \"STREET\", \"POST_CODE\" FROM public.\"ADDRESS\"";
    ...
    public void update(Address address) throws SQLException {
        ...
        String sql = "UPDATE public.\"ADDRESS\" SET \"COUNTRY\"=?, \"CITY\"=?, \"STREET\"=?, \"POST_CODE\"=?" +
                " WHERE \"ID\"=?";
    ...
    public void remove(Address address) throws SQLException {
        ...
        String sql = "DELETE FROM public.\"ADDRESS\" WHERE \"ID\"=?";
